...
const ScheduleList = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] text-white">
      {/* Background Effects */}
      <div className="fixed top-0 left-0 w-96 h-96 bg-cyan-500/20 blur-[140px] rounded-full pointer-events-none" />
      <div className="fixed bottom-0 right-0 w-96 h-96 bg-purple-500/20 blur-[140px] rounded-full pointer-events-none" />
